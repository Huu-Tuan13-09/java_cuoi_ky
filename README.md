...
D:/JAVA_CUOI_KY/  (Thư mục gốc của dự án bạn nộp)
│   MP3ManagerDB.sql
│   pom.xml
│   README.md
│
...
│
├───ffmpeg
│   └───bin  &lt;-- Chứa ffmpeg.exe, ffprobe.exe và các DLL cần thiết
│           avcodec-61.dll
│           avdevice-61.dll
│           avfilter-10.dll
│           avformat-61.dll
...
│   │   └───java
│   │       └───com
│   │           └───yourcompany  &lt;-- Thay "yourcompany" bằng groupId thực tế nếu khác
│   │               └───mp3joiner
│   │                   │   MainApp.java
│   │                   ├───db
│   │                   ├───service
